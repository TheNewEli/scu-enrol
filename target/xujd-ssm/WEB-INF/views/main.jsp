    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="#">您好:${userInfo.name},欢迎登入<code style="font-size: 20px">四川大学2019年本科招生学生答疑系统</code></a></li>
            </ul>
        ...
        <div class="container-fluid">
            ...
            <div>
                <ul class="nav navbar-nav" id="top" style="font-size: 16px;">
                    <li id="userManager"><a href="javascript:void(0)" onclick="menuClick(1,'<%=basePath%>user/selectAll')">咨询回复</a></li>
                </ul>
            </div>
        </div>
    </nav>
